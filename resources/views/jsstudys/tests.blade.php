  ...
  <body class="index-page sidebar-collapse">
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
      <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="now_ui/img/blurred-image-1.jpg">
          <ul class="navbar-nav">
            <li class="nav-item">
    ...
    <div class="wrapper">
      <div class="page-header clear-filter" filter-color="orange">
        <div class="page-header-image" data-parallax="true" style="background-image:url('now_ui/img/header.jpg');">
        </div>
        <div class="container">
          <div class="content-center brand">
            <img class="n-logo" src="now_ui/img/now-logo.png" alt="">
            <h1 class="h1-seo">Now UI Kit.</h1>
            <h3>A beautiful Bootstrap 4 UI kit. Yours free.</h3>
          </div>
          <h6 class="category category-absolute">Designed by
            <a href="http://invisionapp.com/" target="_blank">
              <img src="now_ui/img/invision-white-slim.png" class="invision-logo" />
            </a>. Coded by
            <a href="https://www.creative-tim.com" target="_blank">
              <img src="now_ui/img/creative-tim-white-slim2.png" class="creative-tim-logo" />
            </a>.</h6>
        </div>
      </div>
      <div class="main">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="hero-images-container">
                  <img src="now_ui/img/hero-image-1.png" alt="">
                </div>
                <div class="hero-images-container-1">
                  <img src="now_ui/img/hero-image-2.png" alt="">
                </div>
                <div class="hero-images-container-2">
                  <img src="now_ui/img/hero-image-3.png" alt="">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="section section-navbars">
              ...
              <div class="col-md-6">
                ...
                <nav class="navbar navbar-expand-lg bg-primary">
                  <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="example-navbar" data-nav-image="now_ui/img/blurred-image-1.jpg">
                      <ul class="navbar-nav">
          ...
          <div id="navbar">
            <div class="navigation-example" style="background-image:url('now_ui/img/bg7.jpg')">
              <!-- Navbar Primary  -->
              <nav class="navbar navbar-expand-lg bg-primary">
                <div class="container">
                  <div class="navbar-translate">
            ...
            <div id="images">
              ...
              <div class="row">
                <div class="col-sm-2">
                  ...
                  <img src="now_ui/img/julie.jpg" alt="Rounded Image" class="rounded">
                </div>
                <div class="col-sm-2">
                  <p class="category">Circle Image</p>
                  <img src="now_ui/img/julie.jpg" alt="Circle Image" class="rounded-circle">
                </div>
                <div class="col-sm-2">
                  <p class="category">Raised</p>
                  <img src="now_ui/img/julie.jpg" alt="Raised Image" class="rounded img-raised">
                </div>
                <div class="col-sm-2">
                  <p class="category">Circle Raised</p>
                  <img src="now_ui/img/julie.jpg" alt="Thumbnail Image" class="rounded-circle img-raised">
                </div>
              </div>
            </div>
          </div>
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                      <img class="d-block" src="now_ui/img/bg1.jpg" alt="First slide">
                      <div class="carousel-caption d-none d-md-block">
                        <h5>Nature, United States</h5>
                      </div>
                    </div>
                    <div class="carousel-item">
                      <img class="d-block" src="now_ui/img/bg3.jpg" alt="Second slide">
                      <div class="carousel-caption d-none d-md-block">
                        <h5>Somewhere Beyond, United States</h5>
                      </div>
                    </div>
                    <div class="carousel-item">
                      <img class="d-block" src="now_ui/img/bg4.jpg" alt="Third slide">
                      <div class="carousel-caption d-none d-md-block">
            ...
            <div class="row">
              <div class="col-lg-6 col-md-12">
                ...
                <!-- <div class="nucleo-container">
  							<img src="now_ui/img/nucleo.svg" alt="">
  						</div> -->
        ...
        <div class="section section-signup" style="background-image: url('now_ui/img/bg11.jpg'); background-size: cover; background-position: top center; min-height: 700px;">
          <div class="container">
            <div class="row">
            ...
            <div class="row">
              <div class="col">
                <a href="examples/landing-page.html" target="_blank">
                  <img src="now_ui/img/landing.jpg" alt="Image" class="img-raised">
                </a>
                <a href="examples/landing-page.html" class="btn btn-outline-default btn-primary btn-round">View Landing Page</a>
              </div>
              <div class="col">
                <a href="examples/profile-page.html" target="_blank">
                  <img src="now_ui/img/profile.jpg" alt="Image" class="img-raised">
                </a>
